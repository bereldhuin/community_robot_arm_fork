...
//SERIAL SETTINGS
#define BAUD 115200
#define ENABLE_SERIAL2 1       // Enable Serial2 (TX 16 / RX 17) to connect other device than laptop (esp32,...)
...
#define X_HOME_STEPS 600 //765 //860 // STEPS FROM X_ENDSTOP TO INITIAL_XYZ FOR UPPER ARM
#define Y_HOME_STEPS 1500 //1940 // STEPS FROM Y_ENDSTOP TO INITIAL_XYZ FOR LOWER ARM
#define Z_HOME_STEPS 1500 // STEPS FROM Z_ENDSTOP TO INITIAL_XYZ FOR ROTATION CENTER
...
//GRIPPER SETTINGS
#define GRIPPER SERVO //GRIPPER MOTOR IN USE
